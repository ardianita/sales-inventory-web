        ...
        <div class="col-md-8">
            <div class="card shadow p-3 mb-5 rounded" style="background-color: #242F40; border-width:thin">
                <div class="card-title text-center mt-3">
                    <h1 style="font-weight: bold; color: #ECF2F0">Create Customer</h1>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.store') }}">
                        ...
                        <div class="row mb-5 mx-3">
                            ...
                            <div class="col">
                                ...
                                <input id="domicile" type="text" class="form-control form-control-lg @error('domicile') is-invalid @enderror" name="domicile" autofocus required>
